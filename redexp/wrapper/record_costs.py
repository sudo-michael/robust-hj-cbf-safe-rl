...
class RecordEpisodeStatistics(gym.Wrapper, gym.utils.RecordConstructorArgs):
    ...
    def __init__(self, env: gym.Env, deque_size: int = 100):
        ...
        self.episode_costs: Optional[np.ndarray] = None
        ...
        if num_dones:
            if "episode" in infos or "_episode" in infos:
                ...
                infos["episode"] = {
                    ...
                    "c": np.where(dones, self.episode_costs, 0.0),
            ...
            self.cost_queue.extend(self.episode_costs[dones])
            self.length_queue.extend(self.episode_lengths[dones])
            self.episode_count += num_dones
            self.episode_lengths[dones] = 0
            self.episode_returns[dones] = 0
            self.episode_costs[dones] = 0
